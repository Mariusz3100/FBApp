...
<html xmlns="http://www.w3.org/1999/xhtml" 
   ...
   <body>
	...
	<a href="index.jsp">
		...
		<img src="images/okfs.png" style="position:relative; right:-55%;top:-110px; margin-bottom: -80px">
	
<table style="width:100%">
	  		  <tr>
			    <td><div  style="text-align:center"><img src="images/pstryk.png"></div></td> 
			    <td><div  style="text-align:center"><h1>Konkurs</h1></div></td>
			  </tr>
			</table>
